...
router.get('/', function (req, res) { 
    res.render('index', { title: 'dolphin App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'dolphin App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'dolphin App Login', user : req.user }); 
}); 
